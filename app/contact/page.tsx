...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Fuego Street Kitchen. Book our food truck for your event, ask about catering packages, or find our weekly schedule.',
  keywords: ['Contact Food Truck', 'Catering', 'Book Food Truck', 'Event Catering'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Want to book our truck or have questions about catering? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@rollingfeast.com</p>
                    <p className="text-gray-600">support@rollingfeast.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 890-1213</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Currently rotating locations!<br />
                      Check our schedule for today's spot
                    </p>
                  </div>
                </div>
