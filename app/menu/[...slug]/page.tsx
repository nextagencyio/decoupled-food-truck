...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!item) {
    return { title: 'Menu Item Not Found | Food Truck' }
  }
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <dl className="space-y-4">
                  ...
                  {(item as any).spiceLevel && (
                    <div>
                      <dt className="text-sm text-gray-500">Spice Level</dt>
                      <dd className="font-semibold text-gray-900">{(item as any).spiceLevel}</dd>
                    </div>
                  )}
                </dl>
                <div className="mt-8">
