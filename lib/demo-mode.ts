...
import locationSchedulesData from '@/data/mock/schedule.json'
...
const mockDataMap: Record<string, any> = {
  ...
  'schedule.json': locationSchedulesData,
...
export function handleMockQuery(body: string): any {
  try {
    ...
    if (query.includes('GetLocationSchedules') || query.includes('nodeLocationSchedules')) {
